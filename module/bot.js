...
class Bot {
    ...
    */
    change_message_to_confirm(parameter_key, message){
        ...
        } else if (!!this._context.skill.dynamic_parameter && !!this._context.skill.dynamic_parameter[parameter_key]){
        ...
        this._context.skill[param_type][parameter_key].message_to_confirm = message;
    }
    ...
    */
    _collect_by_parameter_obj(parameter){
        ...
        if (this._context.skill.required_parameter && this._context.skill.required_parameter[param_key]){
            ...
            Object.assign(this._context.skill.required_parameter, parameter);
        } else if (this._context.skill.optional_parameter && this._context.skill.optional_parameter[param_key]){
            // If we have parameter of same parameter key, override it.
            Object.assign(this._context.skill.optional_parameter, parameter);
        } else {
            ...
            Object.assign(this._context.skill.dynamic_parameter, parameter);
        }
